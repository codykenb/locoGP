...
package iaik.ascon128v11NoDeps;
...
class Bits {                            // package-private
    ...
    static ByteOrder byteOrder() {
        ...
        //return byteOrder;
        //return new ByteOrder("BIG_ENDIAN");//ByteOrder.BIG_ENDIAN;
    	return new ByteOrder("LITTLE_ENDIAN");//ByteOrder.BIG_ENDIAN;
    }
    ...
    static boolean unaligned() {
        ...
        /*String arch = AccessController.doPrivileged(
            new sun.security.action.GetPropertyAction("os.arch"));*/ // BCK!
        unaligned = true; /*arch.equals("i386") || arch.equals("x86")
            || arch.equals("amd64");*/
        unalignedKnown = true;
        return unaligned;
    }
