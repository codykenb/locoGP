...
public class HuffmanCodeBookVariant extends HuffmanCodeBookProblem{
	...
	private CompilationSet loadFiles(){
		...
		String fileContents = getStringFromFile("/locoGP/problems/huffmancodebook/BasicHuffman"+variantNum+".txt");
		fileSet[0] = new CompilationDetail(fileContents, "huffmanCodeTable",
				"BasicHuffman"+variantNum);

		fileContents = getStringFromFile("/locoGP/problems/huffmancodebook/BubbleSort"+variantNum+".txt");
		fileSet[1] = new CompilationDetail(fileContents, "huffmanCodeTable",
				"BubbleSort"+variantNum);

		fileContents = getStringFromFile("/locoGP/problems/huffmancodebook/huffmanNode"+variantNum+".txt");
