...
public interface IAllJavaOpcodes {
	...
	static final int NEWARRAY = 188; // visitstatic final intInsn
	static final int NOP = 0; // visitInsn //Can occur in bytecode - is not benchmarked and not relevant for performance
