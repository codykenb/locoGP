...
public static void main(String[] args){
    ...
    int repetitions = 40;
    System.out.println("Linpack_MK, "+repetitions+" repetitions : ");
    long start = 0L;//MK TODO
    long stop = 0L;//MK TODO
	ArrayList<Long> results = new ArrayList<Long>(); 
	for(int i=0; i<repetitions; i++){
		start = System.nanoTime();// MK TODO
	    l.run_benchmark();//TODO: make this field return something...
...
//				+ ns + " ns = " + us + " us = " + ms + " ms = " + s + " s.");// MK
  ...
  final double abs (double d) {//invariant
    return (d >= 0) ? d : -d;
  }
...
*/
	...
	//TODO DRINGEND AUSGABE ZUR JIT-Vermeidung (wir koennen allerdings dadurch nur besser werden)
